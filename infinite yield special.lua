...
CMDs[#CMDs + 1] = {NAME = 'firstperson / firstp', DESC = 'Forces camera to go into first person'}
...
CMDs[#CMDs + 1] = {NAME = 'suicide / fb_real', DESC = 'fb_real moment'}
wait()
...
addcmd('firstperson',{'firstp'},function(args, speaker)
	speaker.CameraMode = "LockFirstPerson"
end)

addcmd('thirdperson',{'thirdp'},function(args, speaker)
	speaker.CameraMode = "Classic"
end)
...
addcmd('remotespy',{'rspy'},function(args, speaker)
	...
	loadstring(game:HttpGet('https://raw.githubusercontent.com/xataxell/Lua-Projects/refs/heads/main/Simple%20Spy'))()
end)
...
addcmd("suicide", {"fb_real"}, function(args, speaker)
    notify('nigga im a rapist', 'Oh, what a wonderful 4.7 years of cheating, ruining lives, and feeling sorry for myself. Can’t wait for this glorious goodbye, please don’t remember me or my endless mistakes. - chatgpt 2025')
end)
